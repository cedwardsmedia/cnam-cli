...
## History
 ...
 - 0.1 [_Jul 2, 2015_] First working version produced.
 - 0.2 [_Oct 22, 2015_] Switched to exception catching for handling HTTP status codes.
 - **1.0** [_Oct 23, 2015_]: Total restructure of code and first public release.
